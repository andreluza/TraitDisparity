...
# -----------------------#
# load data
load (here("output_uncertainty_S2", "mpd_results.RData"))
load (here("output_uncertainty_S2", "RAO_BM.RData"))
load (here("output_uncertainty_S2", "RAO_EB.RData"))
load (here("output_uncertainty_S2", "RAO_OU.RData"))
load (here("output_uncertainty_S2", "RAO_OBS.RData"))
