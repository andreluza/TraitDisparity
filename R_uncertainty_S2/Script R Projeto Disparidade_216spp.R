...
save (RAO_OBS, file = here("output_uncertainty_S2","RAO_OBS.RData"))
...
stopCluster (cl)
# save
save(RAO_BM, file=here("output_uncertainty_S2","RAO_BM.Rdata"))
...
stopCluster (cl)
# save
save (RAO_EB, file = here("output_uncertainty_S2","RAO_EB.RData"))
...
save (RAO_OU, file = here("output_uncertainty_S2","RAO_OU.RData"))
...
# save
save (null.mpdf, file=here ("output_uncertainty_S2","mpd_results.RData"))