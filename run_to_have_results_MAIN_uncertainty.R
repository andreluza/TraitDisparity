...
pdf (here ("output","vectorized","Fig3_all.pdf"), width=8,height=10,family="serif")
...
# plot the map of significance of the deviance between empirical and simulated disparity

pdf (here ("output","vectorized","Fig5_all_significance.pdf"), width=8,height=5,family="serif")
...
png (here ("output","vectorized","Fig5_all.png"), 
