...
load(here ("output", "params_fitcontinuous.RData"))
...
load(here ("output", "params_BM_multivariate.RData"))
...
# plot
params_estim <- grid.arrange(fig_params_BM+ theme(legend.position = c(0.8,0.8),
                                  axis.title.x = element_blank()),
