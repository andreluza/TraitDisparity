...
# save
pdf(here ("output", "vectorized","Fig3_relief.pdf"),width=4,height =9)
panel2
dev.off()
...
pdf(here ("output", "vectorized","Fig4_relief.pdf"),width=5,height =5)
alternative_map1
dev.off()
...
#write.csv (df_qgis, file = here ("output", "df_qgis_size.csv"))
