...
save (RAO_OBS, file = here("output_concensus_supp_S2","RAO_OBS_ORYZ.RData"))
...
# save
save(RAO_BM, file=here("output_concensus_supp_S2","RAO_BM_ORYZ.Rdata"))
...
# save
save (RAO_EB, file = here("output_concensus_supp_S2","RAO_EB_ORYZ.RData"))
...
# save
save (RAO_OU, file = here("output_concensus_supp_S2","RAO_OU_ORYZ.RData"))
...
# save
save (statistics.phy, file=here ("output_concensus_supp_S2","mpd_results_ORYZ.RData"))
