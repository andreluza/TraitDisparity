...
# -----------------------#
# load data
load (here("output_concensus_supp_S2", "mpd_results_ALL.RData"))
load (here("output_concensus_supp_S2", "RAO_BM_ALL.RData"))
load (here("output_concensus_supp_S2", "RAO_EB_ALL.RData"))
load (here("output_concensus_supp_S2", "RAO_OU_ALL.RData"))
load (here("output_concensus_supp_S2", "RAO_OBS_ALL.RData"))
